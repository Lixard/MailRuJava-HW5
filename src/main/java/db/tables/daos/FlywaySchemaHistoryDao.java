...
public class FlywaySchemaHistoryDao extends DAOImpl<FlywaySchemaHistoryRecord, db.tables.pojos.FlywaySchemaHistory, Integer> {

    /**
     * Create a new FlywaySchemaHistoryDao without any configuration
     */
    public FlywaySchemaHistoryDao() {
        super(FlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY, db.tables.pojos.FlywaySchemaHistory.class);
    }
    ...
    public FlywaySchemaHistoryDao(Configuration configuration) {
        super(FlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY, db.tables.pojos.FlywaySchemaHistory.class, configuration);
    }
     ...
     */
    @Override
    protected Integer getId(db.tables.pojos.FlywaySchemaHistory object) {
     ...
     */
    public List<db.tables.pojos.FlywaySchemaHistory> fetchByInstalledRank(Integer... values) {
     ...
     */
    public db.tables.pojos.FlywaySchemaHistory fetchOneByInstalledRank(Integer value) {
     ...
     */
    public List<db.tables.pojos.FlywaySchemaHistory> fetchByVersion(String... values) {
     ...
     */
    public List<db.tables.pojos.FlywaySchemaHistory> fetchByDescription(String... values) {
     ...
     */
    public List<db.tables.pojos.FlywaySchemaHistory> fetchByType(String... values) {
     ...
     */
    public List<db.tables.pojos.FlywaySchemaHistory> fetchByScript(String... values) {
     ...
     */
    public List<db.tables.pojos.FlywaySchemaHistory> fetchByChecksum(Integer... values) {
     ...
     */
    public List<db.tables.pojos.FlywaySchemaHistory> fetchByInstalledBy(String... values) {
     ...
     */
    public List<db.tables.pojos.FlywaySchemaHistory> fetchByInstalledOn(Timestamp... values) {
     ...
     */
    public List<db.tables.pojos.FlywaySchemaHistory> fetchByExecutionTime(Integer... values) {
     ...
     */
    public List<db.tables.pojos.FlywaySchemaHistory> fetchBySuccess(Boolean... values) {
