...
public class Organizations extends TableImpl<OrganizationsRecord> {
    ...
    private static final long serialVersionUID = -1530665865;
     ...
     */
    public final TableField<OrganizationsRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.organizations.name</code>.
     */
    public final TableField<OrganizationsRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>public.organizations.inn</code>.
     */
    public final TableField<OrganizationsRecord, Long> INN = createField("inn", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.organizations.settlement_acc</code>.
     */
    public final TableField<OrganizationsRecord, Long> SETTLEMENT_ACC = createField("settlement_acc", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ORGANIZATIONS_PK);
    }
    ...
    public List<UniqueKey<OrganizationsRecord>> getKeys() {
        return Arrays.<UniqueKey<OrganizationsRecord>>asList(Keys.ORGANIZATIONS_PK);
    }
